...
public class GameViewManager {
    ...
    private final static String BACKGROUND_IMAGE = "C:\\Users\\petko.lyutskanov\\Desktop\\Student\\IdeaProjects\\GalaxyDodger\\GalaxyDodger\\src\\main\\java\\view\\resources\\purple.png";

    private final static String METEOR_BROWM_IMAGE = "C:\\Users\\petko.lyutskanov\\Desktop\\Student\\IdeaProjects\\GalaxyDodger\\GalaxyDodger\\src\\main\\java\\view\\resources\\shipchooser\\meteorBrown_med3.png";
    private final static String METEOR_GREY_IMAGE = "C:\\Users\\petko.lyutskanov\\Desktop\\Student\\IdeaProjects\\GalaxyDodger\\GalaxyDodger\\src\\main\\java\\view\\resources\\shipchooser\\meteorGrey_med2.png";
    ...
    private int points;
    private final static String GOLD_STAR_IMAGE = "C:\\Users\\petko.lyutskanov\\Desktop\\Student\\IdeaProjects\\GalaxyDodger\\GalaxyDodger\\src\\main\\java\\view\\resources\\shipchooser\\star_gold.png";
    ...
    public void createNewGame(Stage menuStage, Ship chosenShip) {
        ...
        gameStage.getIcons().add(new Image("C:\\Users\\petko.lyutskanov\\Desktop\\Student\\IdeaProjects\\GalaxyDodger\\GalaxyDodger\\src\\main\\java\\view\\resources\\shipchooser\\playerShip3_blue.png"));
        gameStage.show();
    ...
    private void createGameElements(Ship chosenShip) {
        ...
        for (int i = 0; i < brownMeteors.length; i++) {
            brownMeteors[i] = new ImageView(METEOR_BROWM_IMAGE);
    ...
    private void setNewElementPosition(ImageView image) {
        image.setLayoutX(randomPositionGenerator.nextInt(520));
